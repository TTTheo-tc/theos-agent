...
from src.config.schema import WhatsAppConfig
...
class WhatsAppChannel(BaseChannel):
                ...
                async with websockets.connect(bridge_url) as ws:
                    ...
                    async for message in ws:
                        try:
                            ...
                            logger.opt(exception=True).warning("Error handling bridge message")
    ...
    async def send(self, msg: OutboundMessage) -> None:
        ...
        try:
            ...
            logger.opt(exception=True).warning("Error sending WhatsApp message")
