...
from src.config.schema import DingTalkConfig
...
class TheOSDingTalkHandler(CallbackHandler):
    """
    ...
    async def process(self, message: CallbackMessage) -> tuple[Any, str]:
        ...
        try:
            ...
            # Forward to TheOS via _on_message (non-blocking).
            ...
            logger.opt(exception=True).warning("Error processing DingTalk message")
...
class DingTalkChannel(BaseChannel):
    ...
    async def start(self) -> None:
        ...
        try:
            ...
            handler = TheOSDingTalkHandler(self)
            ...
            logger.opt(exception=True).warning("Failed to start DingTalk channel")
    ...
    async def _get_access_token(self) -> str | None:
        ...
        try:
            ...
            logger.opt(exception=True).warning("Failed to get DingTalk access token")
            return None
    ...
    async def send(self, msg: OutboundMessage) -> None:
        ...
        try:
            ...
            logger.opt(exception=True).warning("Error sending DingTalk message")

    async def _on_message(self, content: str, sender_id: str, sender_name: str) -> None:
        """Handle incoming message (called by TheOSDingTalkHandler).
        ...
        try:
            ...
            logger.opt(exception=True).warning("Error publishing DingTalk message")
