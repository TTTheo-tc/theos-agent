...
from src.config.schema import QQConfig
...
class QQChannel(BaseChannel):
    ...
    async def send(self, msg: OutboundMessage) -> None:
        ...
        try:
            ...
            logger.opt(exception=True).warning("Error sending QQ message")
    ...
    async def _on_message(self, data: "C2CMessage") -> None:
        ...
        try:
            ...
            logger.opt(exception=True).warning("Error handling QQ message")
