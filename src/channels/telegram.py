...
from src.config.schema import TelegramConfig
from src.utils.text import split_message as _split_message
...
class TelegramChannel(BaseChannel):
    ...
    async def send(self, msg: OutboundMessage) -> None:
        ...
        try:
            ...
            logger.opt(exception=True).warning("Invalid chat_id: {}", msg.chat_id)
            return
        ...
        for media_path in msg.media or []:
            try:
                ...
                logger.opt(exception=True).warning("Failed to send media {}", media_path)
            ...
            for chunk in _split_message(msg.content):
                try:
                    ...
                    try:
                        ...
                        logger.opt(exception=True).warning("Error sending Telegram message")
    ...
    async def _on_start(self, update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
        ...
        await update.message.reply_text(
            f"👋 Hi {user.first_name}! I'm TheOS.\n\n"
        ...
        if media_file and self._app:
            try:
                ...
                if media_type == "voice" or media_type == "audio":
                    from src.providers.transcription import GroqTranscriptionProvider
                ...
                logger.opt(exception=True).warning("Failed to download media")
