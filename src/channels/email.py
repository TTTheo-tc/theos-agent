...
class EmailChannel(BaseChannel):
    ...
    async def start(self) -> None:
        ...
        while self._running:
            try:
                ...
                logger.opt(exception=True).warning("Email polling error")
    ...
    async def send(self, msg: OutboundMessage) -> None:
        ...
        base_subject = self._last_subject_by_chat.get(to_addr, "theos reply")
        ...
        try:
            ...
            logger.opt(exception=True).warning("Error sending email to {}", to_addr)
            raise
    ...
    def _reply_subject(self, base_subject: str) -> str:
        subject = (base_subject or "").strip() or "theos reply"
